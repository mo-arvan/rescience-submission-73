...
class basic_Agent:
    ...
    def __init__(self,environment, gamma=0.95):
        ...
        self.R_VI=np.zeros((self.size_environment,self.size_actions))
...
class Learning_Progress(basic_Agent):
    ...
    def __init__(self,environment, gamma, step_update,alpha,prior_LP):
        ...
        self.last_k=np.zeros((self.size_environment,self.size_actions,self.step_update),dtype=np.int32)
        self.LP=np.ones((self.size_environment,self.size_actions))*np.log(self.size_environment)
