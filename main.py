...
agent_parameters={Epsilon_MB_Agent:{'gamma':0.95,'epsilon':0.1},
            Rmax_Agent:{'gamma':0.95, 'm':6,'Rmax':1,'u_m':10,'correct_prior':True},
            ...
            RmaxLP_Agent:{'gamma':0.95,'Rmax':1,'step_update':10,'alpha':0.3,'m':1.5},}
