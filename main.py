...
play_parameters={'trials':200, 'max_step':30, 'screen':0,'photos':[1,2,10,20,50,80,99],'accuracy_VI':0.01,'step_between_VI':50}

agent_parameters={Epsilon_MB_Agent:{'gamma':0.95,'epsilon':0.2},
            Rmax_Agent:{'gamma':0.95, 'm':10,'Rmax':1,'m_uncertain_states':20,'condition':'wrong_prior'},
            BEB_Agent:{'gamma':0.95,'beta':3,'coeff_prior':1,'condition':'wrong_prior'},
            EBLP_Agent:{'gamma':0.95,'beta':3,'step_update':10,'alpha':0.3,'prior_LP':0.01},
            RmaxLP_Agent:{'gamma':0.95,'Rmax':1,'step_update':10,'alpha':0.3,'m':2,'prior_LP':0.01}}
